...
void BindCastConvexVsTriangles(nb::module_ &m) {
    nb::class_<CastConvexVsTriangles> castConvexVsTrianglesCls(m, "CastConvexVsTriangles",
        "Collision detection helper that casts a convex object vs one or more triangles");
    castConvexVsTrianglesCls
        .def(nb::init<const ShapeCast &, const ShapeCastSettings &, Vec3Arg, Mat44Arg, const SubShapeIDCreator &, CastShapeCollector &>(), "shape_cast"_a, "shape_cast_settings"_a, "scale"_a, "center_of_mass_transform2"_a, "sub_shape_id_creator1"_a, "collector"_a,
            "Constructor.\n"
            "Args:\n"
            "    shape_cast (ShapeCast): The shape to cast against the triangles and its start and direction.\n"
        ...
        .def("cast", &CastConvexVsTriangles::Cast, "v0"_a, "v1"_a, "v2"_a, "active_edges"_a, "sub_shape_id2"_a,
